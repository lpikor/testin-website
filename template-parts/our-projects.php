<section class="section-background">
    ...
    <header class="section-background__header">
        ...
        <p class="section-background__description">Współpracujemy z klientami z różnych branż. Sprawdź nasze projekty w zakresie tworzenia stron internetowych, sklepów www i marketingu internetowego.</p>
    </header>
