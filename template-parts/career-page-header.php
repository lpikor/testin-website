<div class="page-banner-img-container career-page-header-container">
    <div class="page-banner-img career-page-header">
        <div class="page-banner-img__img-container">
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/brainstorming.webp" alt="" class="page-banner-img__img">
        </div>
