    ...
    <section class="section offer-child-stats print-stats">
        ...
        <div class="stats">
            <article class="stats__item">
                ...
                <span class="stats__item-label">Większa rozpoznawalność na rynku</span>
            </article>
            <article class="stats__item">
                <div class="stats__item-chart" data-percent="65">
                    <span class="stats__item-value">65%</span>
                </div>
                <span class="stats__item-label">Więcej propozycji współpracy</span>
            </article>
            <article class="stats__item">
                <div class="stats__item-chart" data-percent="80">
                    <span class="stats__item-value">80%</span>
                </div>
                <span class="stats__item-label">Więcej wpływów na konto Klienta</span>
            </article>
            <article class="stats__item">
